...
const clearChatFunctionSpec = {
  name: "clearChat",
  description:
    "Clear the chat history to start a new conversation. Reduces cost of GPT",
  parameters: {},
};
...
const listSASDataLibFunctionSpec = {
  name: "listSASDataLib",
  description: `list available libs, libraries, caslibs or librefs. Optionally specify the source as cas or compute.`,
  parameters: {
    properties: {
      library: {
        type: "string",
        description: "Ex: list tables in given  caslib casuser, list tables in libref sashelp",
        enum: ["caslibs", "librefs", 'libs'],
      },
      source: {
        type: "string",
        description: "source of the tables. cas or compute. Defaults to last known source",
        enum: ["cas", "compute"]
      },
      ...
      limit: {
          type: "integer",
          description:
            "Return only this many libs. If not specified, then return 10 libs.",
        },
      },
      from: {
        type: "integer",
...
const listColumnsFunctionSpec = {
  name: "listColumns",
  description:
    "Get schema or columns for specified table. Table is of the form sashelp.cars",
  parameters: {
    properties: {
      table: {
        type: "string",
...
const readFileFunctionSpec = {
  name: "readFile",
  description: "read a file. The file is a path to the file",
  parameters: {
    properties: {
      file: {
        type: "string",
...
const keywordsFunctionSpec = {
  name: "keywords",
  description:
    "format a comma-separated keywords like a,b,c into html, array, object",
  parameters: {
    properties: {
      keywords: {
        type: "string",
...
const resumeFunctionSpec = {
  name: "resume",
  description:
    "get resume for a person.ex: resume for deva Deva is a developer",
  parameters: {
    properties: {
      person: {
        type: "string",
